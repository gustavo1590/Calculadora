...
for (let i = 0; i < numbers.length; i++) {
  numbers[i].addEventListener("click", function () {
    ...
    //if condição para que, se a exibição tiver "Infinito", não anexamos dígitos
    if (
      "0123456789.+-×÷".includes(
...
plusMinus.addEventListener("click", function () {
  //Este "if" restringirá a avaliação() se a exibição for do tipo "-". ou "."
...
// Adicionando animação de clique
...
// Em addEventListener, você não pode usar uma função de seta porque a palavra-chave "this" não funcionará conforme o esperado.
